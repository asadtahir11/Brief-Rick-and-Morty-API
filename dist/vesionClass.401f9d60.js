...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"asset/js/config.js":[function(require,module,exports) {
...
},{}],"asset/js/vesionClass.js":[function(require,module,exports) {
...
function () {
  function Episode() {
    ...
    this.fetchData(API.episodeLink + "/" + Array.from({
      ...
      _this.createSectionEpisodes(); //    console.log(episodes);
  ...
  _createClass(Episode, [{
    ...
    value: function createSectionEpisodes() {
      ...
      this.saisonsFilter.forEach(function (saisonFilter, i) {
        ...
        app_lists.appendChild(_this2.createHeader(episodes, i + 1));
      });
    ...
    value: function createEpisodes(episodes) {
      ...
      episodes.forEach(function (episode) {
        ...
        li.querySelector("h2").addEventListener("click", _this3.showCharacters);
        ul.appendChild(li);
      });
      return ul;
    }
...
new Episode();
},{"./config":"asset/js/config.js"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","asset/js/vesionClass.js"], null)
//# sourceMappingURL=/vesionClass.401f9d60.js.map